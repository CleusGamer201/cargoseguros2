                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="listado">
                                <div class="sb-nav-link-icon"><i class="fas fa-boo"></i></div>
                                Listado de PDF
                            </a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Lista de respaldos</h1>           
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($backs as $back)
                                            <tr>
                                                ...
                                                <input name="consecutive" style="display:none;" type="text" value="{{ $back->consecutive }}">
                                                <button type="submit" class="btn btn-sm btn-outline-warning">Editar</button>
                                                </form>               
                                                </td>                                                   
                                                <td>                       
                                                <form action="{{ route('aproved') }}" method="GET">
                                                <input name="backId" style="display:none;" type="text" value="{{ $back->id }}">
                                                ...
                                                <input name="backId" style="display:none;" type="text" value="{{ $back->id }}">
                                                <button type="button" class="btn btn-sm btn-outline-success">Aceptar y Facturar</button>
                                                </form>                                              
                                                </td>
                                            </tr>
                                        @endforeach
