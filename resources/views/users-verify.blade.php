                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Ultimos usuarios registrados<strong>(Pendientes por aceptar)</strong>.
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($users as $user)
                                            <tr>
                                                ...
                                                <td>                                                 
                                                <form action="{{ route('approveUser') }}" method="GET">
                                                    <input name="userid" style="display:none;" type="text" value="{{ $user->id }}">
                                                <button type="submit" class="btn btn-sm btn-outline-success">Verificar</button>
                                                </form>
                                                </td>
                                                <td>                                                
                                                <form action="{{ route('rejectUser') }}" method="GET">
                                                    <input name="userid" style="display:none;" type="text" value="{{ $user->id }}">
