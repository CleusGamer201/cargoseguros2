...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>CargoSeguros | Respaldos</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Respaldos</a>
            <!-- Sidebar Toggle-->
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Respaldos</h1> 
                        <div class="row">
                <button class="col-1 btn btn-outline-success"onClick=" window.location.href='/generar-respaldo' " type="button">Generar</button>
                                    ...
                                    <tbody>
                                        @foreach ($backs as $back)
                                            <tr>
                                                ...
                                                <button type="submit" class="btn btn-sm btn-outline-danger">Pedir petición de eliminado</button>
                                                </form>
                                                </td>
                                            </tr>
                                        @endforeach
